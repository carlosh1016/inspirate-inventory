// Package ventas contains the HTTP handlers for /api/v1/ventas/*.
package ventas
...
// RolVendedora identifies the restricted role: List/Get are scoped to a
// vendedora's own ventas.
const RolVendedora = "vendedora"

// Handler groups the ventas HTTP handlers and their dependencies.
type Handler struct {
