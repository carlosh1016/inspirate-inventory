...
// Create handles POST /api/v1/metodos-pago. Admin-only, enforced by the
// router.
func (h *Handler) Create(w http.ResponseWriter, r *http.Request) {
	var req CreateMetodoPagoRequest
	...
	response.WriteData(w, http.StatusCreated, toMetodoPagoResponse(m))
}
