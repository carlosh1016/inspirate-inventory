...
// Update handles PATCH /api/v1/metodos-pago/:id. Admin-only, enforced by
// the router.
func (h *Handler) Update(w http.ResponseWriter, r *http.Request) {
	...
	var req UpdateMetodoPagoRequest
	...
	response.WriteData(w, http.StatusOK, toMetodoPagoResponse(m))
}
