...
// Create handles POST /api/v1/usuarios.
func (h *Handler) Create(w http.ResponseWriter, r *http.Request) {
	...
	usuario, err := h.service.Create(r.Context(), usecase.CreateInput{
	...
	response.WriteData(w, http.StatusCreated, toUsuarioResponse(usuario))
}
